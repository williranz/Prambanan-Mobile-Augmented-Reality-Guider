package com.willyranz.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.willyranz.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.willyranz.library.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.willyranz.library.BaseAnimationInterface}
 * work.
 *
