...
public class Tem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.pager_tem);
        initializePaging();
    }
    ...
    private List<Fragment> getFragments() {
        ...
        fList.add(Fragment.instantiate(this, Tem_1_1.class.getName()));
        fList.add(Fragment.instantiate(this, Tem_1_2.class.getName()));
        fList.add(Fragment.instantiate(this, Tem_1_3.class.getName()));
        fList.add(Fragment.instantiate(this, Tem_1_4.class.getName()));
        fList.add(Fragment.instantiate(this, Tem_1_5.class.getName()));
        return fList;
    }
