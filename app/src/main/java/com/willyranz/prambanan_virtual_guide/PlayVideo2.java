...
public class PlayVideo2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setticker(ticker_area, "Ramayana Ballet Perform", this);

        getWindow().setFormat(PixelFormat.UNKNOWN);

        final VideoView mVideoView2 = (VideoView)findViewById(R.id.videoView1);

        String uriPath2 = "android.resource://com.willyranz.prambanan_virtual_guide/"+R.raw.ramayana_dance;
        ...
        mVideoView2.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                Log.i("com.willyranz.prambanan_virtual_guide", "Duration = " + mVideoView2.getDuration());
            }
        });
        mVideoView2.start();
    }
