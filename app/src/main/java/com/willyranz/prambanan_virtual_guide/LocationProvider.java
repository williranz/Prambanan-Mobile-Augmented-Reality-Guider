...
import com.willyranz.prambanan_virtual_guide.ArchitectViewHolderInterfaceGeo.ILocationProvider;
...
public class LocationProvider implements ILocationProvider {
    ...
    /** location updates should fire approximatvgely every second */
