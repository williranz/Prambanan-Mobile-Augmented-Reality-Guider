...
public class Rel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.pager_rel);
        initializePaging();
    }
    ...
    private List<Fragment> getFragments() {
        ...
        fList.add(Fragment.instantiate(this, Rel_1_1.class.getName()));
        fList.add(Fragment.instantiate(this, Rel_1_2.class.getName()));
        fList.add(Fragment.instantiate(this, Rel_1_3.class.getName()));
        return fList;
    }
